...
.method private static getApkPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_c
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_c} :catch_36
    ...
    invoke-virtual {v0}, Ljava/io/BufferedReader;->close()V
    :try_end_2b
    .catch Ljava/lang/Exception; {:try_start_23 .. :try_end_2b} :catch_36
...
.method public static init(Landroid/content/Context;)V
    ...
    const-string v1, "\nfParis5uXbbJU/C0d7B5\n"
...
.method public static killOpen(Ljava/lang/String;)V
    ...
    :try_end_5
    .catchall {:try_start_0 .. :try_end_5} :catchall_b4
    ...
    :try_end_28
    .catch Ljava/io/IOException; {:try_start_23 .. :try_end_28} :catch_ad
    ...
    :try_end_46
    .catchall {:try_start_28 .. :try_end_46} :catchall_a3

    :try_start_46
    invoke-virtual {p0}, Ljava/util/zip/ZipFile;->close()V
    :try_end_49
    .catch Ljava/io/IOException; {:try_start_46 .. :try_end_49} :catch_ad
    ...
    move-result-object v2
    :try_end_60
    .catchall {:try_start_4a .. :try_end_60} :catchall_a3
    ...
    :try_end_79
    .catchall {:try_start_76 .. :try_end_79} :catchall_97
    ...
    invoke-virtual {p0}, Ljava/util/zip/ZipFile;->close()V
    :try_end_81
    .catch Ljava/io/IOException; {:try_start_7e .. :try_end_81} :catch_ad
...
.method public static killPM(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_end_1d
    .catch Ljava/lang/Exception; {:try_start_11 .. :try_end_1d} :catch_70
    ...
    invoke-interface {p0}, Ljava/util/Map;->clear()V
    :try_end_6f
    .catchall {:try_start_5e .. :try_end_6f} :catchall_6f
